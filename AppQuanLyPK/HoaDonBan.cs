...
namespace AppQuanLyPK
{
    public partial class HoaDonBan : Form
    {
        ...
        private void LoadInfoHoaDon()
        {
            ...
            str = "SELECT MaKhachHang FROM tblHDBan WHERE MaHDBan = N'" + txtMaHDBan.Text + "'";
        ...
        {
            string sql;
            sql = "SELECT a.MaHang, b.TenHang, a.SoLuong, b.GiaBan, a.GiamGia,a.ThanhTien FROM tblChiTietHDBan AS a, tblHangHoa AS b WHERE a.MaHDBan = N'" + txtMaHDBan.Text + "' AND a.MaHang=b.MaHang";
            ...
            dgvHDBanHang.Columns[0].Width = 120;
            dgvHDBanHang.Columns[1].Width = 160;
            dgvHDBanHang.Columns[2].Width = 120;
            dgvHDBanHang.Columns[3].Width = 150;
            dgvHDBanHang.Columns[4].Width = 140;
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (!Functions.CheckKey(sql))
            {
                ...
                sql = "INSERT INTO tblHDBan(MaHDBan, NgayBan, MaNhanVien, MaKhachHang, TongTien) VALUES (N'" + txtMaHDBan.Text.Trim() + "','" +
            ...
            Functions.RunSQL(sql);
            LoadDataGridView();
            // Cập nhật lại số lượng của mặt hàng vào bảng tblHangHoa
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Bạn có chắc chắn muốn xóa không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                DataTable tblHangHoa = Functions.GetDataToTable(sql);
                for (int hang = 0; hang <= tblHangHoa.Rows.Count - 1; hang++)
                {
                    // Cập nhật lại số lượng cho các mặt hàng
                    sl = Convert.ToDouble(Functions.GetFieldValues("SELECT SoLuong FROM tblHangHoa WHERE MaHang = N'" + tblHangHoa.Rows[hang][0].ToString() + "'"));
                    slxoa = Convert.ToDouble(tblHangHoa.Rows[hang][1].ToString());
                    slcon = sl + slxoa;
                    sql = "UPDATE tblHangHoa SET SoLuong =" + slcon + " WHERE MaHang= N'" + tblHangHoa.Rows[hang][0].ToString() + "'";
                    Functions.RunSQL(sql);
                }
        ...
        private void cboMaKhach_TextChanged(object sender, EventArgs e)
        {
            ...
            str = "Select SoDienThoai from tblKhachHang where MaKhachHang= N'" + cboMaKhach.SelectedValue + "'";
        ...
        private void cboMaHang_TextChanged(object sender, EventArgs e)
        {
            ...
            str = "SELECT GiaBan FROM tblHangHoa WHERE MaHang =N'" + cboMaHang.SelectedValue + "'";
        ...
        private void btnInHoaDon_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["A1:B1"].Value = "Phụ Kiện Điện Thoại";
            exRange.Range["A2:B2"].MergeCells = true;
            exRange.Range["A2:B2"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A2:B2"].Value = "35 Lê Đức Thọ";
            exRange.Range["A3:B3"].MergeCells = true;
            exRange.Range["A3:B3"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A3:B3"].Value = "Điện thoại: 0835179000";
            ...
            sql = "SELECT a.MaHDBan, a.NgayBan, a.TongTien, b.TenKhachHang, b.DiaChi, b.SoDienThoai, c.TenNhanVien FROM tblHDBan AS a, tblKhachHang AS b, tblNhanVien AS c WHERE a.MaHDBan = N'" + txtMaHDBan.Text + "' AND a.MaKhachHang = b.MaKhachHang AND a.MaNhanVien = c.MaNhanVien";
        ...
        private void lblthemkhachhang_Click(object sender, EventArgs e)
        {
